<%@ page contentType="text/html; charset=utf-8" language="java" import="java.sql.*,conn.*" errorPage="" %>
...
<%			
			...
			String s1=(String)ss1.getAttribute("s1");
			if(cep.candFetch(s1))
			{
				gender=cep.degree;
				 branch=cep.degree;
...
%>
        <table width="104%" height="628" border="1">
            ...
            <tr>
             ...
             <form method="post" action="SaveCandEdit.jsp" name="form1" onSubmi="return check()">
   <table border=0 cellpadding=3 cellspacing=0 width =81% align=centert>
    <tr bgcolor =#FEF7E9 wdth =100%>
     <td colspan="2" bgcolor="#E2E0CF">
      <div align="center"><font color="#386A78" size="5"><strong>Edit Profile</strong></font></div>
     </td>
    </tr>
    ...
    <tr bgcolor =#FEF7E9 wdth =100%>
     <td width="48%" bgcolor="#F3E8DA"><strong>
      <font color="#666600" size="3" face="Times New Roman, Times, serif">Name&nbsp;
       <font color="#993333">(as in academic records)</font> 
      </font></strong>
     </td>
     <td width="52%" bgcolor="#F3E8DA">
                   <input TYPE="text" NAME="name" size="30" maxlength=30 value="<% out.print(cep.name); %>"></td>
                            </tr>
                            
                             <tr>
                                
                                <td><strong><font color="#666600" size="3" face="Times New Roman, Times, serif">Gender</font></strong></td>
                                <td><select name="gender" >
                                	<option  value=""><% out.print(cep.gender); %></option>
                            ...
                            <tr bgcolor =#FEF7E9 wdth =100%>
     <td width="48%" bgcolor="#F3E8DA"><strong>
      <font color="#666600" size="3" face="Times New Roman, Times, serif">Date Of Birth
        
      </font></strong>
     </td>
     <td width="52%" bgcolor="#F3E8DA">
                  <input TYPE="text" NAME="dob" size="30" maxlength=30 value="<% out.print(cep.dob); %>"></td> 
                            </tr>
                            
                            <tr bgcolor =#FEF7E9 wdth =100%>
     <td width="48%" bgcolor="#F3E8DA"><strong>
      <font color="#666600" size="3" face="Times New Roman, Times, serif">Branch
        
      </font></strong>
     </td>
     <td width="52%" bgcolor="#F3E8DA">
                  <select name="branch" >
                  						<option value =""><% out.print(cep.branch); %></option>
                            ...
                            <tr bgcolor =#FEF7E9 wdth =100%>
     <td width="48%" bgcolor="#F3E8DA"><strong>
      <font color="#666600" size="3" face="Times New Roman, Times, serif">Degree
     ...
     <td width="52%" bgcolor="#F3E8DA">
                   ...
                   <select name="degree">
                   						<option value =""><% out.print(cep.degree); %></option>
                             ...
                             <tr bgcolor =#FEF7E9>
                                ...
                                <td bgcolor="#F3E8DA"><input TYPE="text" NAME="collname" size=30 maxlength=30 value='<% out.print(cep.collname); %>'>                       </td>
                            </tr>
                            <tr bgcolor =#FEF7E9>
                                <td bgcolor="#F3E8DA">
                                    <strong><font SIZE="3" COLOR="#666600" face ='Times New Roman, Times, serif'>College Phone</font> </strong>
                                </td>
                                <td bgcolor="#F3E8DA"><input TYPE="text" NAME="collphone" size=30 maxlength=30                                       value='<% out.print(cep.collphone); %>'><font SIZE="2" COLOR="#CC0000" face =arial (STD-No.)>                                 </td>
                            </tr>
                            <tr bgcolor="#FFFFFF">
                                <td>
                                    <strong><font SIZE="3" COLOR="#666600" face ='Times New Roman, Times, serif'>College Email</font> </strong>
                                </td>
                                <td><input TYPE="text" NAME="email" size=30 maxlength=50 value='<% out.print(cep.email); %>'>                                 </td>
                            </tr>
                            <tr bgcolor =#FEF7E9>
                                <td bgcolor="#F3E8DA">
                                ...
                                <td bgcolor="#F3E8DA">
                                    <table width="111" border=0 cellpadding=0 cellspacing=0>
                                        ...
                                        <tr>
                                            <td><input TYPE="text" NAME="marks" size=8 maxlength=8 value='<% out.print(cep.marks); %>' onblur="checkDec('markBSC')">                                              </td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                            <tr  bgcolor =#FEF7E9>
                                ...
                                <td bgcolor="#F3E8DA"><input TYPE="text" NAME="emailid" size=30 maxlength=30 value='<% out.print(cep.emailid); %>'></td>
                            </tr>
                            <tr bgcolor="#FFFFFF">
                                <td>
                                <strong><font SIZE="3" COLOR="#666600" face ='Times New Roman, Times, serif'>Telephone Number</font> </strong></td>
                                <td><input NAME="telephone" TYPE="text" id="telephone" value="<% out.print(cep.telephone); %>">
                            ...
                            <tr  bgcolor =#FEF7E9>
                                ...
                                <td bgcolor="#F3E8DA">
                                    <input class=USS_TEXT maxLength=30 name="addr" size=40 value='<% out.print(cep.addr); %>'><b><font face="ARIAL, HELVETICA" color=red size=+2></font></b>
                                </td>
                            </tr>
                            <tr bgcolor="#FFFFFF">
                                <td><strong><font face="Times New Roman, Times, serif" color=#666600 size=3>State</font> </strong></td>
                                <td><select name="states"> 
                                <option selected value=""><% out.print(cep.states); %></option>
                            ...
                            <tr bgcolor="#FFFFFF">
                                ...
                                <td bgcolor="#F3E8DA"><INPUT class=USS_TEXT maxLength=6 name="pincode" size=6 value='<% out.print(cep.pincode); %>'><B>
                                    <FONT face="ARIAL, HELVETICA" color=red size=+2></FONT></B></td></tr>
                                    <tr> <td width="48%" bgcolor="#F3E8DA"><strong>
      <font color="#666600" size="3" face="Times New Roman, Times, serif">Category
        
      </font></strong>
     </td><td>
                                    <input type="text" name="category" id="category" value="<% out.print(cep.category); %>" />
                                </td>
                            </tr>
                            
                            <tr>
                                <td height="49" colspan=2 align="center" ><input TYPE="submit" value="Edit" onClick="return check()"></td>
                            </tr>
                        </table>
                    </form>
