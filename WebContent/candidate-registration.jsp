...
<body style="margin: 0px" bgcolor="#624631"><jsp:useBean id="cep"
		class="bean.CandRejValues" />
	...
	<table width="100%" border="1" bgcolor="#624631">
		...
		<tr>
			...
			<td width="759" bgcolor="#FFFFFF"><form
					action="rcd.jsp" method="post" name="form1" id="form1"
					onsubmit="return check()">
					<table width="115%" border="0" cellpadding="3" cellspacing="0"
						bordercolor="#FFFFFF" align="left">
						<tr bgcolor="#E9E9D8" wdth="100%">
							<td height="27" colspan="4" bgcolor="#FEF7E9"><div
									align="center" class="style4">
									<font color="#006666">Registration</font>
								</div></td>
						...
						<tr bgcolor="#E9E9D8" width="100%">
							...
							<td width="32%"><font size="2" color="black" face="arial">Name&nbsp;<font
									color="blue"> (as in academic records) </font></font></td>
							<td width="52%"><input type="text" name="name" size="30"
						...
						<tr bgcolor="#FEF7E9">
							<td bgcolor="#FEF7E9"><span class="style5"></span></td>
							<td><font size="2" color="black" face="arial">Date
									of Birth&nbsp;</font><font color="blue">(dd/mm/yy)</font></td>
							<td><jsp:include page="datePicker.html" /><!-- <input type="text" name="dob" size="30" maxlength="30" /> --></td>
						...
						<tr bgcolor="#E9E9D8">
							<td bgcolor="#FEF7E9"><span class="style5"></span></td>
							<td><font size="2" color="black" face="arial">Telephone
									Number</font></td>
							<td><input type="text" name="landLineNumber" value="" /> <font
								size="2" color="#CC0000" face="arial">(STD-No.)</font></td>
							<td bgcolor="#FEF7E9">&nbsp;</td>
						</tr>
						...
						<tr bgcolor="#E9E9D8">
							<td bgcolor="#FEF7E9"><span class="style5"></span></td>
							<td height="29"><font size="2" color="black" face="arial">College
									in which studying</font></td>
							<td><input type="text" name="collname" size="30"
								maxlength="30" /></td>
							<td bgcolor="#FEF7E9">&nbsp;</td>
						</tr>
						<tr bgcolor="#E9E9D8">
							<td bgcolor="#FEF7E9"><span class="style5"></span></td>
							<td><font size="2" color="black" face="arial">College
									Phone</font></td>
							<td><input type="text" name="collphone" size="30"
								maxlength="30" /> <font size="2" color="#CC0000" face="arial">(STD-No.)</font></td>
							<td bgcolor="#FEF7E9">&nbsp;</td>
						</tr>
						<tr bgcolor="#E9E9D8">
							<td bgcolor="#FEF7E9"><span class="style5"></span></td>
						...
						<tr>
							<td bgcolor="#FEF7E9"><span class="style5"></span></td>
							<td><font size="2" color="black" face="arial">Branch
									of study</font></td>
						...
						<tr bgcolor="#E9E9D8">
							<td bgcolor="#FEF7E9"><span class="style5"></span></td>
							<td><font size="2" color="black" face="arial">% of
									Marks</font></td>
							<td><table width="220" border="0" cellpadding="0"
									cellspacing="0">
									<tr>
										<td width="72"><div align="center">
												<font size="1" color="black" face="arial">X % </font>
											</div></td>
										<td width="73"><div align="center">
												<font size="1" color="black" face="arial">XII %</font>
											</div></td>
										<td width="75"><div align="right">
												<font size="1" color="black" face="arial">BCA / B.Sc.
													%</font>
											</div></td>
									</tr>
									<tr>
										<td><div align="center">
												<font size="1" color="black" face="arial"> <input
													type="text" name="mark10" size="5" maxlength="5" value=''
													onblur="checkDec('mark10')" />
												</font>
											</div></td>
										<td><div align="right">
												<input type="text" name="mark12" size="5" maxlength="5"
													value='' onblur="checkDec('mark12')" />
											</div></td>
										<td>

											<div align="right">
												<input type="text" name="markDegree" size="5" maxlength="5"
													value='' onblur="checkDec('markBSC')" />
											</div>
										</td>
									</tr>
								</table></td>
						...
						<tr bgcolor="#E9E9D8">
							...
							<td><input class="USS_TEXT" maxlength="30" name="addr"
								size="40" value='' /> <b><font face="ARIAL, HELVETICA"
									color="red" size="+2"></font></b></td>
							<td bgcolor="#FEF7E9">&nbsp;</td>
						</tr>
						<tr bgcolor="#E9E9D8">
							<td bgcolor="#FEF7E9"><span class="style5"></span></td>
						...
						<tr>
							...
							<td><input class="USS_TEXT" maxlength="6" name="pincode"
								size="6" value='' /></td>
							<td bgcolor="#FEF7E9">&nbsp;</td>
						</tr>
						<tr bgcolor="#E9E9D8">
							...
							<td><select name="isExperienced" id="sel_cat"
						...
						<tr bgcolor="#FEF7E9">
							<td bgcolor="#FEF7E9"><span class="style5"></span></td>
							<td><font size="2" color="black" face="arial">Experienced
									Years</font></td>
							<td><input type="text" name="expyears" id="expyears"
						...
						<tr bgcolor="#FEF7E9">
							<td bgcolor="#FEF7E9"><span class="style5"></span></td>
							<td><font size="2" color="black" face="arial">Designation
							</font></td>
						...
						<tr bgcolor="#FEF7E9">
							...
							<td><input type="text" name="salary" id="salary" size="30"
								maxlength="30" /></td>
							<td>&nbsp;</td>
						</tr>
						<tr bgcolor="#FEF7E9">
							<td bgcolor="#FEF7E9"><span class="style5"></span></td>
							<td><font size="2" color="black" face="arial">Company
									Address</font></td>
						...
						<tr>
							<td colspan="4" align="center" bgcolor="#FEF7E9"><br /> <input
								type="reset" /> &nbsp;&nbsp;&nbsp;&nbsp; <input type="submit"
								value="submit" /> <br /> <br /></td>
						</tr>
					</table>
				</form></td>
		</tr>
